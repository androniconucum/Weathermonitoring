...
return (
  ...
  const getLightLabel = (light, theme) => {
    const darkColors = {
      ...
      bright: { label: "Bright", labelColor: "#854D0E", indicatorColor: "#D97706" }
    };
  
    const lightColors = {
      dark: { label: "Dark", labelColor: "#E5E7EB", indicatorColor: "#9CA3AF" },
      bright: { label: "Bright", labelColor: "#FEF3C7", indicatorColor: "#FBBF24" }
    };
